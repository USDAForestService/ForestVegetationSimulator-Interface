          ...
          tabPanel("Graphs",
            ...
            fixedRow(column(width=6, 
              ...
              textOutput("plotMessage")),
                column(width=6,h6(),actionButton("copyplot","Copy to clipboard"))),
            ...
            fixedRow(
              ...
              column(width=4,offset=0, 
                colourInput(inputId="svsPlotColor1",label="Plot color", showColour="both", 
                            value = "#C5FAC6"),
                actionButton(inputId="svsCopy1","Copy to clipboard"))),
            selectInput(inputId="SVSImgList1",label="Select SVS image", choices=NULL, 
              multiple=FALSE, selectize=FALSE, width="99%"),
            fixedRow(
              column(width=6,offset=0,uiOutput("SVSqImg1Top")),
              column(width=6,offset=0,uiOutput("SVSqImg1Side"))),
            ...
            fixedRow(
              ...
              column(width=4,offset=0, 
                colourInput(inputId="svsPlotColor2",label="Plot color", showColour="both", 
                            value = "#C5FAC6"),
                actionButton(inputId="svsCopy2","Copy to clipboard"))),
            selectInput(inputId="SVSImgList2",label="Select SVS image", choices=NULL, 
              multiple=FALSE, selectize=FALSE, width="99%"),
            fixedRow(
              column(width=6,offset=0,uiOutput("SVSqImg2Top")),
              column(width=6,offset=0,uiOutput("SVSqImg2Side"))),
